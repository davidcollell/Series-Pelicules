...
export const FilmIcon = ({ className = "h-8 w-8 text-brand-primary" }: { className?: string }) => (
...
export const StarIcon = ({ filled, className = "h-5 w-5" }: { filled: boolean; className?: string }) => (
